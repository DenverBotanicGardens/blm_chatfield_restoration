...
boxplot(days_until_flower ~ Pop_ID, data = ERNA.crop, main = "ERNA Days until flower by Population", 
...
boxplot(length_cm_20220915 ~ Pop_ID,data=ERNA.crop, main="ERNA Plant Height by Population", 
